        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className=" text-center z-50 font-syne text-md mx-auto font-black text-brand-purple bg-brand-purple/10 p-2 mb-10 rounded-full w-fit transition-colors duration-300 pointer-events-none">
                {step.id}
              </div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                {/* Icon Container */}
                <div className={`mb-6 inline-flex h-14 w-14 items-center justify-center rounded-xl mx-auto transition-colors duration-300 ${step.color} group-hover:bg-brand-purple group-hover:text-white`}>
                  {step.icon}
                </div>
